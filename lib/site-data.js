...
export const attorneys = {
  "george-richards": {
    ...
    name: "George L. Richards III",
    firstName: "George",
    role: "Principal",
    roleEyebrow: "Principal · Real Estate, Zoning & Permitting",
    pageTitle: "George L. Richards III",
    subtitle: "Real Estate, Zoning & Permitting Attorney",
    image: "/assets/img/richards_full.jpg",
    imageAlt: "George L. Richards III",
    phone: "(508) 655-1660",
    email: "grichards@southnaticklaw.com",
    summary:
      "George joined the firm in 1992 and focuses primarily on real estate, zoning, permitting, and small business law.",
    practices: ["Real Estate", "Zoning & Permitting", "Small Business Law"],
    metaDescription:
      "George L. Richards III is a principal attorney at South Natick Law focusing on real estate, zoning, permitting, and small business law in MetroWest MA.",
    meta: [
    ...
    bioParagraphs: [
      "GEORGE L. RICHARDS III, ESQ. joined the firm in 1992 and has been the managing partner since 2004. George has over 40 years of experience in commercial and residential real estate law, estate planning/probate law and small business law but he now focuses his practice primarily on zoning and permitting, particularly in Natick where he served as an elected member of the Natick Planning Board for over 10 years.",
      "George is currently a member of the Massachusetts Bar Association and the Massachusetts Real Estate Bar Association and is an agent for Old Republic Title Insurance Company. He has also been a member of the Natick Rotary Club since 1998 where he has volunteered hundreds of hours for the benefit of the Natick Community.",
    ],
    practiceAreas: [
      "Commercial Real Estate",
      "Residential Real Estate",
  ...
  "richard-biller": {
    ...
    cardImage: "/assets/img/biller_card.jpg",
    imageAlt: "Richard Biller",
    phone: "(508) 650-1550",
    email: "rbiller@southnaticklaw.com",
    summary:
      "Richard joined the firm in 1995 and has been an attorney for 39 years. His practice focuses on domestic relations and employment law.",
    practices: ["Domestic Relations", "Employment Law"],
    metaDescription:
      "Richard Biller is a principal attorney at South Natick Law with 39 years of experience in domestic relations and employment law, serving the MetroWest Massachusetts area.",
    meta: [
    ...
    bioParagraphs: [
      ...
      "Mr. Biller has been a member of the Family Law Section of the Massachusetts Bar Association, a frequent lecturer on Domestic Relations law for Massachusetts Legal Education and has served on the Board of Metrowest Legal Services. Mr. Biller has been an attorney for 39 years and his practice focuses on domestic relations and employment law.",
    ],
    practiceAreas: [
      "Domestic Relations",
      "Divorce & Custody",
  ...
  "kimberly-winter": {
    ...
    cardImage: "/assets/img/winter_card.jpg",
  ...
  "alex-mulcahy": {
    ...
    cardImage: "/assets/img/mulcahy_card.jpg",
